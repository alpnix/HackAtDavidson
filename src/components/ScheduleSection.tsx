  ...
  const schedule = [
    {
      ...
      events: [
        ...
        { time: "6:00 PM", title: "Opening Ceremony", description: "Welcome and event kickoff" },
        ...
        { time: "8:00 PM", title: "Hardware Workshop", description: "Eric Beall" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "1:00 PM", title: "Security Workshop", description: "Dr. Mendes" },
        { time: "3:00 PM", title: "Data Science Workshop", description: "Dr. Wang" },
        { time: "5:00 PM", title: "Co-Pilot Workshop", description: "Genevieve from MLH" },
        { time: "6:00 PM", title: "Dinner", description: "Evening meal" },
        { time: "8:00 PM", title: "AI Studio Workshop", description: "Genevieve from MLH" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "1:00 PM", title: "Lunch", description: "Meal break" },
        { time: "3:00 PM", title: "Closing Ceremony", description: "Winner announcements and awards" },
        { time: "4:00 PM", title: "Happy Hour", description: "Network with tech figures from Silicon Valley" },
        { time: "6:00 PM", title: "Event Ends", description: "See you next year!" },
      ],
    },
  ];
                  ...
                  {day.events.map((event, eventIndex) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h4 className="text-lg sm:text-xl font-bold text-card-foreground mb-1">{event.title}</h4>
